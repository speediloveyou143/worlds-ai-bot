...
function Course(props) {
  return (
    <div className="relative bg-gradient-to-br from-gray-800 via-gray-900 to-blue-900 rounded-xl overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl w-full group">
